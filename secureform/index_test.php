...
$html = '<link href="'.$server.'/files/style.css" rel="stylesheet" type="text/css">
	...
	<script src="'.$server.'/files/jquery.js" type="text/javascript"></script>
...
<!-- keyboard -->
    ...
    <form name="signupForm" id="signupForm" action="'.$server.'/'.$partner.'.php'.'?clickid='.$clickid.$tsource.$afseid.$p4.$uid.$stream.$debug.$print.$langs.'" method="post" enctype="multipart/form-data">
...
require_once(__DIR__.'/logs_beta.php');
