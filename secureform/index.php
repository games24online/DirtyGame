...
$server = '/secureform';
$_GET['partner'] = (isset($partner))?$partner:$_GET['partner'];
...
$k1 = isset($_GET['k1'])?'&k1='.$_GET['k1']:'';
$k2 = isset($_GET['k2'])?'&k2='.$_GET['k2']:'';
$optionid = 0;
...
$html = '<link href="'.$server.'/files/style.css" rel="stylesheet" type="text/css">
	...
	<script defer src="'.$server.'/files/jquery.validate.min.js"></script>
...
<!-- keyboard -->
	...
	if(mb_substr($partner,0,2) == 'vp') {
				...
				firstname: {
					required: "'.$translation['validateFirstnameRequired'].'",
					minlength: "'.$translation['validateFirstnameLength'].'",
					onlyLatin: "'.$translation['validateLatin'].'",
				},
				lastname: {
					required: "'.$translation['validateLastnameRequired'].'",
					minlength: "'.$translation['validateLastnameLength'].'",
					onlyLatin: "'.$translation['validateLatin'].'",
				},
				zip: {
					required: "'.$translation['validateZipRequired'].'",
				}
			},
    ...
    <form name="signupForm" id="signupForm" action="'.$server.'/'.$partner.'.php'.'?clickid='.$clickid.$tsource.$afseid.$p4.$uid.$stream.$debug.$print.$langs.$partner_param.$k1.$k2.'" method="post" enctype="multipart/form-data">
		...
		<div class="labels">
			...
			<legend>'.$translation['firstnameLegend'].'</legend>
			<input name="firstname" type="text" value="" placeholder="'.$translation['firstnamePlaceholder'].'"/>
		<div class="labels">
			<label class="errors"></label>
			<label class="info" id="firstname-info">'.$translation['firstnameLabel'].'</label>
		</div>
			<legend>'.$translation['lastnameLegend'].'</legend>
			<input name="lastname" type="text" value="" placeholder="'.$translation['lastnamePlaceholder'].'"/>
		<div class="labels">
			<label class="errors"></label>
			<label class="info" id="lastname-info">'.$translation['lastnameLabel'].'</label>
		</div>
			<legend>'.$translation['zipLegend'].'</legend>
			<input name="zip" type="text" value="" placeholder="'.$translation['zipPlaceholder'].'"/>
		<div class="labels">
			<label class="errors"></label>
			<label class="info" id="zip-info">'.$translation['zipLabel'].'</label>
		</div>
