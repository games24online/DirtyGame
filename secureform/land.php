...
file_put_contents(__DIR__.'/logs/land.txt', var_export($_POST,true));
...
function ga() {
    if( $curl = curl_init()) {
		...
		echo 'https://www.google-analytics.com/mp/collect?measurement_id='.$_GET['stream'].'&api_secret='.getKey($_GET['stream']);
