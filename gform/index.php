...
$partner = (isset($partner))?$partner:'vp';
...
$ts =(isset($_GET['tsource']))?$_GET['tsource']:'vp';
...
<!-- keyboard -->
	...
	if(mb_substr($partner,0,2) == 'vp' || mb_substr($partner,0,2) == 'bb') {
					$html .= 'remote: {
						url: "'.$server.'/mx.php",
						type: "post",
						data: {
...
$referer = (strlen($_SERVER['HTTP_REFERER'])>0)?$_SERVER['HTTP_REFERER']:'//'.$_GET['lphost'].'/'.$_GET['lpname'].str_replace('/gform/index.php', '', $_SERVER['REQUEST_URI']);
